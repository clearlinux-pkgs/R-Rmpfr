...
Version  : 0.7.1
Release  : 12
URL      : https://cran.r-project.org/src/contrib/Rmpfr_0.7-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/Rmpfr_0.7-1.tar.gz
Summary  : R MPFR - Multiple Precision Floating-Point Reliable
Group    : Development/Tools
License  : GPL-2.0+
Requires: R-Rmpfr-lib
Requires: R-dfoptim
Requires: R-gmp
Requires: R-pracma
Requires: R-sfsmisc
...
export LANG=C
export SOURCE_DATE_EPOCH=1532974613
